...
public class Atendente extends Funcionario {
	private List<Cliente> possiveisClientes;
	private List<Cliente> clientesInativos;
	...
	public Atendente(String nome, String cpf, String endereco, String nTelefone, String email, String nCtps,
			double salario, LocalDate dataContratacao, double comissaoFixa, Credenciais credenciaisAtendente) {
	...
	public void cancelaPlano() {
		...
		if (temCliente == false) {
			System.out.println(
					"Não tem nenhum cliente com o CPF " + cpfCliente + " que tenha um plano na nossa empresa!");
		}
		sc.close();
	}
	...
	public List<Cliente> getPossiveisClientes() {
	...
	public String toString() {
		return "Nome: " + this.getNome() + " - CPF: " + this.getCpf() + " - Numero de telefone: " + this.getnTelefone()
				...
				+ this.getComissaoFixa() + " - Esse atentende trabalha na cidade " + this.cidade;
	}

	public void abrirInterfaceGrafica() {
		AtendenteGUI.abrirInterfaceGrafica(this);
	}
}
