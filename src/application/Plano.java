...
public class Plano {
	...
	List<Especialidades> especialidadesPlanos = new ArrayList<>();
	...
	public List<Especialidades> getEspecialidadesPlanos() {
	...
	public String toString() {
		...
		for (Especialidades ep : especialidadesPlanos) {
			sb.append(ep);
		}
...
/*
 * Um plano vendido pela empresa tem uma lista de especialidades médicas e uma
 * lista com os nomes das clínicas e hospitais que aceitam aquele plano. Cada
 * especialidade tem um nome e o percentual de desconto dado pelo plano.
 */
