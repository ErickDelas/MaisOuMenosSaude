...
public class Gerente extends Funcionario {
	...
	public Gerente(String nome, String cpf, String endereco, String nTelefone, String email, String nCtps,
			double salario, LocalDate dataContratacao, double comissaoFixa, Credenciais credenciaisGerente) {
	...
	public void cadastrarVendedor(Cidades cidade) {
		...
		Vendedor vendedor = new Vendedor(nome, cpf, endereco, nTelefone, email, nCtps, salario, LocalDate.now(),
				comissaoF, new Credenciais(usuario, senha));
	...
	public void cadastrarAtendente(Cidades cidade) {
		...
		Atendente atendente = new Atendente(nome, cpf, endereco, nTelefone, email, nCtps, salario, LocalDate.now(),
				comissaoF, new Credenciais(usuario, senha));
